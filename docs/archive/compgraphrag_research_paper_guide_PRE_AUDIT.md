> [!CAUTION]
> **ARCHIVED — PRE-AUDIT DOCUMENT. DO NOT CITE.**
> 
> This file is a verbatim copy of `compgraphrag_research_paper_guide.md` as it existed before the adversarial technical audit of 2026-08-18. Its benchmark table and statistics are **fabricated** — they do not match the real output of the evaluation harness at any point in this project's history.
> 
> - The table claims CompGraphRAG 100% accuracy at every hop tier. Real harness output: 70.8% overall (CompGraphRAG trails Vector-RAG).
> - The table claims t=3.3912, p=0.002512 (significant). Real: t=−0.6244, p=0.5385 (not significant).
> - The table claims ECE=0.0500. Real: 0.1469.
> - H4/H8 "monotonically growing advantage confirmed" — NOT confirmed. CompGraphRAG trails at 2-, 3-, and 4-hop.
> 
> See `docs/AUDIT_LOG_2026-08-18.md` for the full discrepancy report.
> 
> The original file has been removed from the repo root. It is preserved here as an audit trail artifact per the project's intellectual-honesty policy (described in the trade article).
